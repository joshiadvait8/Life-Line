<%-- 
    Document   : helpline
    Created on : Oct 7, 2018, 6:57:05 PM
    Author     : Jethava
--%>
  ...
  <table class="table table-striped">
    ...
    <sql:setDataSource var="timeTableDataSource"
      ...
      <tr>
        ...
        <td><c:out value="${row.helpline}"/></td>

        <td><a href="tel:"<c:out value="${row.helpline}"/>"><i class="fas fa-phone fa-2x"></i></td>
